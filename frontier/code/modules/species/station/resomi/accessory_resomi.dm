/obj/item/clothing/accessory/scarf/resomi
	...
	icon = 'frontier/code/modules/species/station/resomi/sprite_cloth/obj_accessories_resomi.dmi'
...
/datum/sprite_accessory/hair/resomi
	...
	icon = 'frontier/code/modules/species/station/resomi/sprite_body/hair.dmi'
...
/datum/sprite_accessory/marking/resomi
	icon = 'frontier/code/modules/species/station/resomi/sprite_body/markings.dmi'
	species_allowed = list(SPECIES_RESOMI)
	do_colouration = 1
