...
/obj/item/clothing/suit/storage/toggle/Resomicoat
	 name = "small cloak"
	 icon = 'frontier/code/modules/species/station/resomi/sprite_cloth/obj_suit_resomi.dmi'
...
/obj/item/clothing/suit/storage/hooded/polychromic/New()
	..()
	sprite_sheets = list(
		SPECIES_RESOMI = 'frontier/code/modules/species/station/resomi/sprite_cloth/onmob_suit_resomi.dmi'
	)
	if(pockets)
		qdel(pockets)
	pockets = new/obj/item/weapon/storage/internal/pouch(src, slots*BASE_STORAGE_COST(ITEM_SIZE_SMALL))
...
/obj/item/clothing/head/winterhood/polychromic_hood
	name = "hood"
	icon = 'frontier/code/modules/species/station/resomi/sprite_cloth/obj_head_resomi.dmi'
...
/obj/item/clothing/head/winterhood/polychromic_hood/New()
	..()
	sprite_sheets = list(
		SPECIES_RESOMI = 'frontier/code/modules/species/station/resomi/sprite_cloth/onmob_head_resomi.dmi'
	)
