/obj/item/clothing/glasses/sunglasses/lenses
	...
	item_icons = list(slot_glasses_str = 'frontier/code/modules/species/station/resomi/sprite_cloth/onmob_eyes_resomi.dmi')
	icon = 'frontier/code/modules/species/station/resomi/sprite_cloth/obj_eyes_resomi.dmi'
